...
draft: false
summary: "I'm excited to announce significant changes for Cob's Farm, including wiping out Alpha Fields and introducing a new environment and quest line. This marks the start of an iterative development process. While there's no set date for the reset, current quests will remain in your log, though Alpha Fields won't be accessible. I'm working on the new map and will provide updates as I progress."
