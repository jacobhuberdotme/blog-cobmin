...
date: "2024-06-05"
summary: >
  "New Beginnings in Cob's Farm: Farewell to Alpha Fields" announces significant changes to Cob's Farm, including the removal of Alpha Fields and the introduction of a new environment and quest line. While there's no set date for the reset, players are encouraged to complete ongoing quests as Alpha Fields will soon be inaccessible. The post previews new map features, enhanced quests, and emphasizes community involvement in the development process. Updates will be shared regularly on Discord and X, inviting the community to follow along and provide feedback.
...
Cob's Farm is resetting by removing Alpha Fields and introducing a new environment and quest line. Complete ongoing quests soon, as Alpha Fields will become inaccessible. Follow updates on Discord and X for progress details.
