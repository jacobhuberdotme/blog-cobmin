...
date: "2023-09-25"
summary: >
  "Introducing Alpha Fields: A Deeper Dive into Cob's Farm" explores the foundational stage of Cob's Farm, blending farming with dungeon battles. This closed alpha phase, accessible to CobLooper NFT owners, serves as a live testing ground for the game's development. The post details various activities and features like fishing, mining, and owning shops, and emphasizes the importance of community feedback. Alpha Fields aims to create a dynamic, player-driven experience, inviting players to shape the future of Cob's Farm through their involvement and suggestions.
...
Alpha Fields in Cob's Farm is the initial phase where peaceful farming meets dungeon battles. It serves as a live testing ground for gameplay elements, influenced by player feedback and NFTs on the Loopring blockchain.
